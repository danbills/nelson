...
object SchedulerOp {
  ...
  final case class Launch(i: Image, dc: Datacenter, ns: NamespaceName, a: Manifest.Versioned[UnitDef], p: Plan, hash: String, bp: RenderedBlueprint) extends SchedulerOp[String]
  ...
  def launch(i: Image, dc: Datacenter, ns: NamespaceName, a: Manifest.Versioned[UnitDef], p: Plan, hash: String, bp: RenderedBlueprint): SchedulerF[String] =
